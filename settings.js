...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=irx3CD5I#eXSKulbOmiVjLF-0bE6ZMMSLtDE7lo8ymC-iDBbCTQI' : process.env.SESSION_ID,
...
ALLWAYS_OFFLINE: process.env.ALLWAYS_OFFLINE === undefined ? "trur" : process.env.ALLWAYS_OFFLINE,
